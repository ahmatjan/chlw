...
<div class="txsqdd">
      ...
      <div class="zhqlrbox2">
        <div class="zhqlsctx">
          <div class="zhqltxbg"><a href="./user.html?key=70">
        ...
        <div class="zhqltxscan">
          <div class="hyuser">欢迎，<span id="username">如梦纷飞</span></div>
          <div class="zhqlsqtxbtn"><a href="javaScript:;" onclick='loginShow("UploadImgAlert",true)'><img src="/images/zhqlsqtxbtn.gif" width="90" height="32" border="0" /></a></div>
        </div>
      </div>

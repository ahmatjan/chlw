...
<!--头部橘黄色部分-->
	<div class="togetherPlan_topCenter">
		<div class="togetherPlan_topLeft"></div>
			...
			<s:if test='#request.torder.lotno=="J00001"'><img src="/images/logo_jczq_b.gif" width="54" height="54" /></s:if>
...
<!--详情内容部分-->
	...
	<tr>
		...
		<input name="" type="button" class="light huiZeng" value="<s:if test='#request.type=="1"'>再送一次</s:if><s:else>回赠好友</s:else>" onclick="javaScript:window.location.href='/shuangseqiu.html?canshu=zengsong#BettingForm'"/></s:if>
		<s:if test='#request.torder.lotno=="T01001"||#request.torder.lotno=="DLT_23529"'>
		<input name="" type="button" class="light huiZeng" value="<s:if test='#request.type=="1"'>再送一次</s:if><s:else>回赠好友</s:else>" onclick="javaScript:window.location.href='/daletou.html?canshu=zengsong#BettingForm'"/></s:if>
		</td>
	</tr>
	<tr>
		<th>方案详情</th>
		...
		<s:if test='#request.torder.lotno=="T01003"||#request.torder.lotno=="ZC_11"||#request.torder.lotno=="T01004"||#request.torder.lotno=="ZC_19"||#request.torder.lotno=="T01005"||#request.torder.lotno=="ZC_18"||#request.torder.lotno=="T01006"||#request.torder.lotno=="ZC_16"'>
		  <tr class="PlanContent_Football ZuCai_outsideSpace ">
			...
			<a href="/rules/moreBetInfo.html?orderid=${torder.id}&a=1" target="_blank" onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))">显示全部内容</a>
		    </s:if>
			</s:if>

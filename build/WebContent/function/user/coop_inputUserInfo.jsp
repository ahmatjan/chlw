...
<table><tr><td id="logo"><a href="http://www.88967.com/portal.php"><img src="/images/cddlogo.gif"  style="display:block; float:left; margin:0px 0px 0px 0px;"/></a><a href="/index.html"><img src="/images/ryclogo.gif" style="display:block; float:left; margin:0px 0px 0px 0px;" /></a></td></tr></table><dl><dt>客服热线：400-655-1000</dt><dd><a href="/index.html">返回首页</a></dd></dl>
</div>
	...
	<div class="RegistePannel">
		...
		<div class="RegistePannelBody">
			...
			<table class="RegistePannelTable">
				...
				<tr><th>昵　称：</th><th colspan="2"><input type="text" class="registerinput" name="nickname" id="nickname" type="text" onfocus="registerFocus(2);"/></th><td><span id="nicknameTip" class="nichengtsh"></span></td></tr>
				...
				<tr><th>&#160;</th><td colspan="3"><input type="submit" class="SubmitForSure" id="phoneregister_submit" value="" onclick ="getvaliate();"/></td></tr>
			</table>
			</form>
...
function getvaliate(){
	if($("#msg").html()==""||$("#msg").html()==null){
		notRepeat('phoneregister_submit','SubmitForSure','zhcezhongbtn');
	}else{
		repeat('phoneregister_submit','zhcezhongbtn','SubmitForSure');
	}
}

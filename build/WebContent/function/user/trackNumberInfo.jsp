...
<div class="userright">
        ...
        <div class="xiangqing">
            <ul>
               ...
               <li class="x_top" >投注内容：<!--<font class="red1">03，07，08，15，18</font>&nbsp;|&nbsp;<font class="blue">07</font>
                   <div class="x_number"><font class="red1">03，07，08，15，18</font>&nbsp;|&nbsp;<font class="blue">07</font></div> -->              
			  <div class="x_number">
	...
	<div class="user_content">
	  <div class="tzjl_tzr">追号过程：</div>
            ...
            <tbody>
              ...
              <s:if test="#request.ordersArray.size()>0">
				  ...
				  <tr>
					...
					<s:if test='lotno=="F47103"||lotno=="D3"'>
					<font class="red">
					...
					<s:if test='lotno=="F47102"||lotno=="QL730"'>
					<font class="red">
					<s:property value="winbasecode.substring(0,2)"/>&nbsp;
					<s:property value="winbasecode.substring(2,4)"/>&nbsp;
					<s:property value="winbasecode.substring(4,6)"/>&nbsp;
					...
					<s:if test='lotno=="T01001"||lotno=="DLT_23529"'>
					<font class="red">
					<s:property value="winbasecode.substring(0,2)"/>&nbsp;
					<s:property value="winbasecode.substring(2,4)"/>&nbsp;
					<s:property value="winbasecode.substring(4,6)"/>&nbsp;
					...
					<font style='color:blue'>
					<s:property value="winspecialcode.substring(0,2)"/>&nbsp;
					<s:property value="winspecialcode.substring(2,4)"/>&nbsp;
					</font>
					</s:if>
					<s:else>
					<font class="red">
	                ...
	                <td class="record_biao2"><font class="blue1"><a href='/rules/oneBetInfo.html?flowno=${id}&play_name=<s:property value="lotno"/>&batchcode=<s:property value="batchcode"/>' target="_blank" title="查看">查看</a></font></td>
	    ...
	    <div class="page1" style="float:left; width:100%;">
	      <p class="x_page"><font class="red3"><a href="/rules/user.html?key=1" title="返回追号记录">返回追号记录</a></font> &nbsp;</p><div style="clear:both;"></div>
	    </div>
	    </div>
	</div>
</div>
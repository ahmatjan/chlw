...
<style>div.My_account{ width:778px; padding:0px;} div.My_account h2{ margin:0 14px;}</style>
	...
	<div class="cash_Records none selected">
		<table class="cashRecords_time" cellspacing="0" cellpadding="0">
			<tr>
				<td>起始日期：</td>
				<td><input type="text" id="startDate" name="startDate" value="<s:property value="#request.startDate"/>" onFocus="WdatePicker({alwaysUseStartDate:true})"type="text" class="account_time" /></td>
		<td>截止日期：</td>
		<td><input type="text" id="stopDate" name="stopDate" value="<s:property value="#request.stopDate"/>" onFocus="WdatePicker({alwaysUseStartDate:true})"type="text" class="account_time" /></td>
				...
				<%//-- 交易时间 --%>
					...
					<td>
						<s:if test='state=="1"'>待处理</s:if>
				  		<s:elseif test='state=="102" || state=="103"'>处理中</s:elseif>
					...
					<td >
						<s:if test='state=="1"'>
						<input type="button" value="撤销" onclick="cancelCash();" >
						<input type="hidden" value='<s:property value="id"/>'  id="orderid">
						</s:if>
					</td>
				</tr>
				</s:iterator>
	...
	<s:if test='#request.objValue!=null'>
		<p id="fenye" class="account_page"> <%/**<a href="#"><span class="fenye1">首页</span></a> <a href="#"><span class="fenye5">&nbsp;</span></a><a href="#"><span class="fenye2">1</span></a> <a href="#"><span class="fenye2">2</span></a> <a href="#"><span class="fenye2">3</span></a> <a href="#"><span class="fenye2_hover">4</span></a> <a href="#"><span class="fenye2">5</span></a> <a href="#"><span class="fenye2">6</span></a> <a href="#"><span class="fenye2">7</span></a> <a href="#"><span class="fenye2">8</span></a><a href="#"><span class="fenye2">9</span></a><a href="#"> <span class="blue">&middot;&middot;&middot;</span></a><a href="#"><span class="fenye2">22</span></a><a href="#"><span class="fenye4">&nbsp;</span></a><a href="#"><span class="fenye1">尾页</span></a><span><input class="fenye_input" name="Input" type="text" /></span><span class="fenye3">&nbsp;</span>*/ %> 
			${pageHtml}
		</p>
	</s:if>

 ...
 <thead>
  ...
  <s:if test="#request.list.size()>0">
	...
	<s:else><tr class="tfoot"></s:else>
		...
		<s:elseif test='torder.lotno=="T01010"||torder.lotno=="XYXW_23009"'>江西11选5</s:elseif>
	    ...
	    <s:elseif test='torder.lotno=="J00001"'>竞彩足球胜平负</s:elseif>
	    ...
	    <s:elseif test='torder.lotno=="J00005"'>竞彩篮球胜负</s:elseif>
	    <s:elseif test='torder.lotno=="J00008"'>竞彩篮球大小分</s:elseif>
	    <s:elseif test='torder.lotno=="J00007"'>竞彩篮球胜分差</s:elseif>
	    <s:elseif test='torder.lotno=="J00006"'>竞彩篮球让分胜负</s:elseif>
		...
		<td>
		<s:if test='torder.bettype==3 && torder.tlotcaseid != null && !torder.tlotcaseid.equals("null")'>
		<a href='/chlw/function/selectAll!getCaseDetail?caselotId=<s:property value="torder.tlotcaseid"/>'  target="_blank">查看</a>
		</s:if>
		<s:else>
		<a href='/rules/oneBetInfo.html?flowno=<s:property value="torder.id"/>&play_name=<s:property value="torder.lotno"/>&batchcode=<s:property value="torder.batchcode"/>'  target="_blank">查看</a>
		</s:else>
		</td>
	</tr>

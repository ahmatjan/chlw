...
<!--头部橘黄色部分-->
	<div class="togetherPlan_topCenter">
		<div class="togetherPlan_topLeft"></div>
			...
			<s:if test='#request.subscribeObj.lotno=="F47104"'><img src="/images/logo_ssq_b.gif" width="54" height="54" /></s:if>
			<s:if test='#request.subscribeObj.lotno=="T01001"'><img src="/images/logo_dlt_b.gif" width="54" height="54" /></s:if>
			<s:if test='#request.subscribeObj.lotno=="F47103"'><img src="/images/logo_fcsd_b.gif" width="54" height="54" /></s:if>
			<s:if test='#request.subscribeObj.lotno=="F47102"'><img src="/images/logo_qlc_b.gif" width="54" height="54" /></s:if>
			<s:if test='#request.subscribeObj.lotno=="T01002"'><img src="/images/logo_pls_d.gif" width="54" height="54" /></s:if>
			<s:if test='#request.subscribeObj.lotno=="T01011"'><img src="/images/logo_plw_d.gif" width="54" height="54" /></s:if>
			<s:if test='#request.subscribeObj.lotno=="T01009"'><img src="/images/logo_qxc_d.gif" width="54" height="54" /></s:if>
			<s:if test='#request.subscribeObj.lotno=="T01007"'><img src="/images/logo_ssc_b.gif" width="54" height="54" /></s:if>
			<s:if test='#request.subscribeObj.lotno=="T01010"'><img src="/images/logo_syxw_b.gif" width="54" height="54" /></s:if>
			<s:if test='#request.subscribeObj.lotno=="T01012"'><img src="/images/logo_syydj_b.gif" width="54" height="54" /></s:if>
			</div>
			...
			<dl>
				...
				<dd>
				<s:if test='#request.subscribeObj.lotno=="F47104"' ><a href="/shuangseqiu.html" title="返回购买双色球">返回购买双色球</a></s:if>
				<s:elseif test='#request.subscribeObj.lotno=="F47103"'><a href="/fucai3D.html" title="返回购买福彩3D">返回购买福彩3D</a></s:elseif>
				<s:elseif test='#request.subscribeObj.lotno=="F47102"' ><a href="/qilecai.html" title="返回购买七乐彩">返回购买七乐彩</a></s:elseif>
				<s:elseif test='#request.subscribeObj.lotno=="T01002"' ><a href="/pailie3.html" title="返回购买排列三">返回购买排列三</a></s:elseif>
				<s:elseif test='#request.subscribeObj.lotno=="T01001"' ><a href="/daletou.html" title="返回购买大乐透">返回购买大乐透</a></s:elseif>
				<s:elseif test='#request.subscribeObj.lotno=="T01011"'><a href="/pailie5.html" title="返回购买排列五">返回购买排列五</a></s:elseif>
				<s:elseif test='#request.subscribeObj.lotno=="T01009"'><a href="/qixingcai.html" title="返回购买七星彩">返回购买七星彩</a></s:elseif>
				<s:elseif test='#request.subscribeObj.lotno=="T01010"'><a href="/11xuan5.html" title="返回购买江西11选5">返回购买江西11选5</a></s:elseif>
				<s:elseif test='#request.subscribeObj.lotno=="T01007"'><a href="/shishicai.html" title="返回购买时时彩">返回购买时时彩</a></s:elseif>
				<s:elseif test='#request.subscribeObj.lotno=="T01012"'><a href="/shiyiyunduojin.html" title="返回购买十一运夺金">返回购买十一运夺金</a></s:elseif>
				</dd>
			</dl>
		</div>
		...
		<td>
			...
			<tr>
			   ...
			   <s:if test='orderstate.equals("等待处理") || orderstate.equals("已撤销")'> <td>--</td></s:if>
				<s:else><td class="blue1"><a href='/rules/oneBetInfo.html?flowno=${id}&play_name=<s:property value="lotno"/>&batchcode=<s:property value="batchcode"/>' target="_blank" title="查看">查看</a></td></s:else>
			</tr>
			 </s:iterator> 
		</table>
		</td>

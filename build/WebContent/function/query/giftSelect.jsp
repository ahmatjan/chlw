...
<form action="#" method="post" id="betSelect" onsubmit='return TZSelectreHtmlInParameters(this.lotno.value , this.beginTime.value , this.endTime.value , "settleFlag="+this.settleFlag.value+"&pageCount="+($("#pageCount").find("td").find("input:checked").val())) ;' class="tzjl_form">
		<div class="my_account">
			...
			<span class="a_detailedTitle">以下是您赠彩记录</span>
			...
			<table class="account_check"  cellspacing="0" cellpadding="0">
				<tr>
					...
					<td><input name="button" id="button"  type="submit" class="account_checkBtn" value="查询"/></td>
				</tr>
			</table>
			...
			<table class="account_day"  cellspacing="0" cellpadding="0">
				...
				<s:else><tr class="accountDay_greyBg"></s:else>
					...
					<s:elseif test='presentDetails.lotno=="T01010"||presentDetails.lotno=="XYXW_23009"'>江西11选5</s:elseif>
				    ...
				    <s:elseif test='presentDetails.lotno=="J00001"'>竞彩足球胜平负</s:elseif>
					<s:else>&nbsp;</s:else>
					</td>
					...
					<%/* 期号  */ %>
					<td><s:if test='presentDetails.lotno=="J00001"'>-</s:if><s:else><s:property value="torder.batchcode"/></s:else></td>
					<td><s:property value="presentDetails.nickName"/></td>
					<td>¥<s:property value="torder.amt"/></td>
					...
					<td><a href='/rules/oneBetInfo.html?flowno=<s:property value="presentDetails.orderid"/>&play_name=<s:property value="presentDetails.lotno"/>&batchcode=<s:property value="presentDetails.batchcode"/>&type=1'  target="_blank">查看</a></td>
<!-- 					<td> -->
<%-- 						<s:if test='reciveState==0'>未领取</s:if> --%>
<%-- 						<s:elseif test='reciveState==1'>已领取</s:elseif> --%>
<!-- 					</td> -->
				</tr>
				</s:iterator>
				</s:if>
				...
				<s:else><tr class="accountDay_greyBg"></s:else>
					...
					<%/* 期号  */ %>
					<td><s:if test='presentDetails.lotno=="J00001"'>-</s:if><s:else><s:property value="presentDetails.batchcode"/></s:else></td>
					<td><s:property value="presentDetails.nickName"/></td>
					<td>¥<s:property value="torder.amt"/></td>
					<td><s:property value="presentDetails.createtime"/></td>
					<td>
				...
				<s:else>
	           	<tr><td colspan="9" align="center" height="28">无赠送记录</td></tr>
	       		</s:else>
			</table>

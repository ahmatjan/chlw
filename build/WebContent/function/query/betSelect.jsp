...
<script type="text/javascript" src="/chlw/function/js/jtip.js" language="javascript"></script>
		<div class="user_head">
		...
		<div class="user_content">
			...
			<form action="/chlw/user/selectAll!betSelect" method="post" onsubmit="return TZSelectreHtmlInParameters(this.lotNo.value,this.startDate.value,this.stopDate.value)">
			<div class="record_cx">			
			...
			<s:if test='#stat.isEven()'>	
				...
				<td class="record_biao3" >
					<!--<input type="button" value="详细信息" id="xinxi<s:property value="#stat.index"/>" onmouseover="onset(<s:property value="#stat.index"/>)"/>
					<div title="详细投注信息" id="betInfo<s:property value="#stat.index"/>" style="display:none">
						<ul>
							<li>【<span>彩种</span>】<s:if test='play_name=="F47104"||play_name=="B001"' >双色球</s:if>
							...
							<li>【<span>投注日期</span>】<s:property value="sell_datetime"/></li>
							<li>【<span>开奖日期</span>】<s:property value="cash_date_time"/></li>
							<li>【<span>投注号码</span>】<s:property value="betCode"/></li>
						</ul>	
					</div>-->
					
					<a href="/chlw/user/selectAll!oneBetSelect?play_name=<s:property value="lotno"/>&&betchcode=<s:property value="btchcode"/>" class="jTip" id="one" name="投注详情">详细信息</a>

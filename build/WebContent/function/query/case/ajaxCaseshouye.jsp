...
<!-- 合买推荐-->
			<table class="index_buyListTable">
				<thead>
					<tr>
						<th>彩种</th><th>发起人</th><th>战绩</th><th>方案金额</th><th>进度</th><th>剩余金额</th><th>参与认购</th><th>详情</th>
					</tr>
				</thead>
				<tbody>
				...
				>
						...
						<s:elseif test='#list.torder.lotno=="J00001"'>竞彩足球胜平负<s:set id="lotno_cn" value='"竞彩足球胜平负"' /></s:elseif>

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<s:if test='#list.userinfo.nickname==null||#list.userinfo.nickname.equals("null")||#list.userinfo.nickname.equals("")||#list.userinfo.nickname.equals(" ")' ><s:property value="#list.userinfo.mobileid.substring(0,4)" />***</s:if><s:else><s:property value="#list.userinfo.nickname" /></s:else>

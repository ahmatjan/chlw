...
<script type="text/javascript">
	$(document).ready(function () {
		...
		<!--  SSQ  -->
			<!--  Banner start  -->
				<ol style="background:url(/images/logo_ssq_b.gif) no-repeat 15px 15px;">
					<li>
						<!-- 期号 截至时间  倒计时    开始 -->
						<script>$(function(){getBatchCode('F47104');});</script>
						<img src="/images/word_ssq.gif" /><i>当前期第<strong id="qihao"></strong>期　每周二、四、日晚开奖，单注最高奖金1000万元！　</i><span id="jinrikaijiangId"></span>
					</li>
					<li>
				...
				<div class="ChannelBuyHandleMainTab">
					<dl class="ChannelBuyTab">
						...
						<dt class="light" onclick="location.href='/shuangseqiu.html'">选号投注</dt>
						<dt class="light" onclick="location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'">我的方案</dt>
...
<s:elseif test='#lotno_p=="F47103"'>
	...
	$(document).ready(function () {
		...
		getIssueByLotNo('F47103');
			...
			<!--  Banner start  -->
				<ol style="background:url(/images/logo_fcsd_b.gif) no-repeat 15px 15px;">
					<li>
						<!-- 期号 截至时间  倒计时    开始 -->
				...
				<div class="ChannelBuyHandleMainTab">
					<dl class="ChannelBuyTab">
						<dt class="light selected" >参与合买</dt>
						<dt class="light" onclick="location.href='/fucai3D.html'">选号投注</dt>
						<dt class="light" onclick="location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'">我的方案</dt>
						<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
						<dd>
			...
			<!--  Banner start  -->
				<ol style="background:url(/images/logo_qlc_b.gif) no-repeat 15px 15px;">
					<li>
						...
						<img src="/images/word_qlc.gif" /><i>当前期第<strong id="qihao"></strong>期　每周一、三、五开奖，2元赢取500万！　</i><span id="jinrikaijiangId"></span>
					</li>
					<li>
						截止时间：<font id="endTime"></font><em>还剩：<strong><font id="day"></font>天<font id="hour"></font>时<font id="minute"></font>分<font id="second"></font>秒</strong></em>
						<span class="qihaoSelectBox">期号查询
				...
				<div class="ChannelBuyHandleMainTab">
					<dl class="ChannelBuyTab">
						<dt class="light selected" >参与合买</dt>
						<dt class="light" onclick="location.href='/qilecai.html'">选号投注</dt>
						<dt class="light" onclick="location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'">我的方案</dt>
						<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
						<dd>
...
<s:elseif test='#lotno_p=="T01013"'>
	...
	$(document).ready(function () {
		...
		getIssueByLotNo('T01013');
			...
			<!--  Banner start  -->
				<ol style="background:url(/images/logo_eexw_b.gif) no-repeat 15px 15px;">
					<li>
						<!-- 期号 截至时间  倒计时    开始 -->
						<script>$(function(){getBatchCode('T01013');});</script>
						<img src="/images/word_eexw.gif" /><i>当前期第<strong id="qihao"></strong>期　每晚20:30开奖，2元赢取500万！　</i><span id="jinrikaijiangId"></span>
					</li>
					<li>
						截止时间：<font id="endTime"></font><em>还剩：<strong><font id="day"></font>天<font id="hour"></font>时<font id="minute"></font>分<font id="second"></font>秒</strong></em>
						<span class="qihaoSelectBox">期号查询
				...
				<div class="ChannelBuyHandleMainTab">
					<dl class="ChannelBuyTab">
						<dt class="light selected" >参与合买</dt>
						<dt class="light" onclick="location.href='/22xuan5.html'">选号投注</dt>
						<dt class="light" onclick="location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'">我的方案</dt>
						<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
						<dd>
							<a target="_blank" href='/bangzhuzhongxin/wanfajieshao/guanfangwanfajieshao/20110615133657_601.html?id=601&code1=135&code='>玩法介绍</a>
...
<s:elseif test='#lotno_p=="T01001"'>
	...
	$(document).ready(function () {
		...
		getIssueByLotNo('T01001');
			...
			<!--  Banner start  -->
				<ol style="background:url(/images/logo_dlt_b.gif) no-repeat 15px 15px;">
					<li>
						<!-- 期号 截至时间  倒计时    开始 -->
						<script>$(function(){getBatchCode('T01001');});</script>
						<img src="/images/word_dlt.gif" /><i>当前期第<strong id="qihao"></strong>期　每周一、三、六晚开奖，3元可赢取1600万元！　</i><span id="jinrikaijiangId"></span>
					</li>
					<li>
						截止时间：<font id="endTime"></font><em>还剩：<strong><font id="day"></font>天<font id="hour"></font>时<font id="minute"></font>分<font id="second"></font>秒</strong></em>
						<span class="qihaoSelectBox">期号查询
				...
				<div class="ChannelBuyHandleMainTab">
					<dl class="ChannelBuyTab">
						<dt class="light selected" >参与合买</dt>
						<dt class="light" onclick="location.href='/daletou.html'" >选号投注</dt>
						<dt class="light" onclick="location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'" >我的方案</dt>
						<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
						<dd>
...
<s:elseif test='#lotno_p=="T01002"'>
	...
	$(document).ready(function () {
		...
		getIssueByLotNo('T01002');
			...
			<!--  Banner start  -->
				<ol style="background:url(/images/logo_pls_d.gif) no-repeat 15px 15px;">
					<li>
						<!-- 期号 截至时间  倒计时    开始 -->
						<script>$(function(){getBatchCode('T01002');});</script>
						<img src="/images/word_pls.gif" /><i>当前期第<strong id="qihao"></strong>期　固定奖，玩法简单，每晚20：30开奖！　</i><span id="jinrikaijiangId"></span>
					</li>
					<li>
						截止时间：<font id="endTime"></font><em>还剩：<strong><font id="day"></font>天<font id="hour"></font>时<font id="minute"></font>分<font id="second"></font>秒</strong></em>
						<span class="qihaoSelectBox">期号查询
				...
				<div class="ChannelBuyHandleMainTab">
					<dl class="ChannelBuyTab">
						<dt class="light selected" >参与合买</dt>
						<dt class="light" onclick="location.href='/pailie3.html'" >选号投注</dt>
						<dt class="light" onclick="location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'" >我的方案</dt>
						<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
						<dd>
...
<s:elseif test='#lotno_p=="T01011"'>
	...
	$(document).ready(function () {
		...
		getIssueByLotNo('T01011');
			...
			<!--  Banner start  -->
				<ol style="background:url(/images/logo_plw_d.gif) no-repeat 15px 15px;">
					<li>
						<!-- 期号 截至时间  倒计时    开始 -->
						<script>$(function(){getBatchCode('T01011');});</script>
						<img src="/images/word_plw.gif" /><i>当前期第<strong id="qihao"></strong>期　天天开奖，固定奖金10万元！　</i><span id="jinrikaijiangId"></span>
					</li>
					<li>
						截止时间：<font id="endTime"></font><em>还剩：<strong><font id="day"></font>天<font id="hour"></font>时<font id="minute"></font>分<font id="second"></font>秒</strong></em>
						<span class="qihaoSelectBox">期号查询
				...
				<div class="ChannelBuyHandleMainTab">
					<dl class="ChannelBuyTab">
						<dt class="light selected" >参与合买</dt>
						<dt class="light" onclick="location.href='/pailie5.html'" >选号投注</dt>
						<dt class="light" onclick="location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'" >我的方案</dt>
						<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
						<dd>
...
<s:elseif test='#lotno_p=="T01009"'>
	...
	$(document).ready(function () {
		...
		getIssueByLotNo('T01009');
			...
			<!--  Banner start  -->
				<ol style="background:url(/images/logo_qxc_d.gif) no-repeat 15px 15px;">
					<li>
						<!-- 期号 截至时间  倒计时    开始 -->
						<script>$(function(){getBatchCode('T01009');});</script>
						<img src="/images/word_qxc.gif" /><i>当前期第<strong id="qihao"></strong>期　每周二、五、日开奖，2元赢取500万！　</i><span id="jinrikaijiangId"></span>
					</li>
					<li>
						截止时间：<font id="endTime"></font><em>还剩：<strong><font id="day"></font>天<font id="hour"></font>时<font id="minute"></font>分<font id="second"></font>秒</strong></em>
						<span class="qihaoSelectBox">期号查询
				...
				<div class="ChannelBuyHandleMainTab">
					<dl class="ChannelBuyTab">
						<dt class="light selected" >参与合买</dt>
						<dt class="light" onclick="location.href='/qixingcai.html'" >选号投注</dt>
						<dt class="light" onclick="location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'" >我的方案</dt>
						<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
						<dd>
...
<s:elseif test='#lotno_p=="T01003"'>
	...
	<ol style="background:url(/images/logo_zc_b.gif) no-repeat 15px 15px;">
			<li>
				...
				<img src="/images/word_zcsf.gif" /><i>当前期第<strong id="qihao3">000000</strong><strong id="qihao2"></strong><strong id="qihao1"></strong>期　无足彩,不球迷,猜14场比赛，赢百万奖金！　</i><span id="jinrikaijiangId"><!-- 此处会显示今日开奖小图标 --></span>
			</li>
			<li>
		...
		<div class="ChannelBuyHandleMainTab" id="zucainavcon">
			<dl class="ChannelBuyTab">
				<dt class="light selected" onclick="window.location.href='/hemai/zcshengfuhemai.html'">参与合买</dt>
				<dt class="light" onclick="window.location.href='/zucaishengfu.html'">标准投注</dt>
...
//	$(document).ready(cleanReady9);
	...
	<ol style="background:url(/images/logo_zc_b.gif) no-repeat 15px 15px;">
			<li>
				...
				<img src="/images/word_rxjc.gif" /><i>当前期第<strong id="qihao3">000000</strong><strong id="qihao2"></strong><strong id="qihao1"></strong>期　无足彩,不球迷,猜14场比赛，赢百万奖金！　</i><span id="jinrikaijiangId"><!-- 此处会显示今日开奖小图标 --></span>
			</li>
			<li>
				截止时间：<font id="endTime"></font><em>还剩:<strong><font id="day">0</font>天<font id="hour">0</font>时<font id="minute">0</font>分<font id="second">0</font>秒</strong></em>
				<span class="qihaoSelectBox">期号查询
		...
		<div class="ChannelBuyHandleMainTab" id="zucainavcon">
			<dl class="ChannelBuyTab">
				<dt class="light selected" onclick="window.location.href='/hemai/zcrenxuanhemai.html'">参与合买</dt>
				<dt class="light" onclick="window.location.href='/renxuan9chang.html'">标准投注</dt>
				<dt class="light" onclick="window.location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'">我的方案</dt>
				<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
				<dd>
					<a style="border:none;" target="_blank" 
...
<s:elseif test='#lotno_p=="T01006"'>
	...
	<ol style="background:url(/images/logo_zc_b.gif) no-repeat 15px 15px;">
		...
		<div class="ChannelBuyHandleMainTab" id="zucainavcon">
			<dl class="ChannelBuyTab">
				<dt class="light selected" onclick="window.location.href='/hemai/zcbanquanhemai.html'">参与合买</dt>
				<dt class="light"  onclick="window.location.href='/6changbanquan.html'">标准投注</dt>
				<dt class="light" onclick="window.location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'">我的方案</dt>
				<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
				<dd>
					<a style="border:none;" target="_blank" 
...
<s:elseif test='#lotno_p=="T01005"'>
	...
	<ol style="background:url(/images/logo_zc_b.gif) no-repeat 15px 15px;">
					<li>
						...
						<img src="/images/word_scjq.gif" /><i>当前期第<strong id="qihao3">000000</strong><strong id="qihao2"></strong><strong id="qihao1"></strong>期　进几个球，你说了算　</i><span id="jinrikaijiangId"><!-- 此处会显示今日开奖小图标 --></span>
					</li>
					<li>
						截止时间：<font id="endTime"></font><em>还剩:<strong><font id="day">0</font>天<font id="hour">0</font>时<font id="minute">0</font>分<font id="second">0</font>秒</strong></em>
						<span class="qihaoSelectBox">期号查询
				...
				<div class="ChannelBuyHandleMainTab" id="zucainavcon">
					<dl class="ChannelBuyTab">
						<dt class="light selected" onclick="window.location.href='/hemai/zcjinqiuhemai.html'">参与合买</dt>
						<dt class="light" onclick="window.location.href='/4changjinqiu.html'">标准投注</dt>
						<dt class="light" onclick="window.location.href='/rules/user.html?key=0&view=ChildMenu2&style=menu2'">我的方案</dt>
						<dt class="LaunchCase" onclick="faqiHemaiTiaozhuan('${lotno_p}')"><a class="light">发起合买&gt;&gt;</a></dt>
						<dd>
							<a style="border:none;" target="_blank" 
	...
	<dl class="TogetherListSearch">
		<dt>
			...
			<div id="CaseCelebrity">
				<script type="text/javascript">$(function () { $.get("/chlw/function/hemaiCenter!getCaseCelebrity?lotno=<s:property value="#lotno_p" />", function (data, textStatus){$("#CaseCelebrity").html(data);});	</script>
			</div>
		</dt>
		<dd>
...
<!--				<th><a href="javascript:;" onclick="fanganListToUser('<s:property value="#list.starter.userno" />',$(this).text())" onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))" >-->
				...
				***<s:property value="#list.starter.mobileid.substring(6)" /></s:if>
				<s:else><s:property value="#list.starter.nickname" /></s:else>-->
<!--				</a></th>-->
<!--				<th>-->
...
<s:elseif test='#lotno_p=="F47104"||#lotno_p=="F47103"||#lotno_p=="F47102"||#lotno_p=="T01002"||#lotno_p=="T01011"||#lotno_p=="T01009"||#lotno_p=="T01001"||#lotno_p=="T01013"'>
...
<s:elseif test='#lotno_p=="T01004"||#lotno_p=="T01006"||#lotno_p=="T01005"||#lotno_p=="T01003"'>
	<!--  R9C 6C 4C 14C -->

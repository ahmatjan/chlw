...
<input type="hidden" id="fangan_state" name="state" value="1,2,3,4" />
			...
			<!--足彩-->
				<div class="Change3 FootballLottery none" id="followFootball">
						<dl class="ChangeInput">
							...
							<dd id="BtnL"  onclick='$("#fangan_state").val("1,2");$("#CaseFanganSelectForm").submit();'>认购中</dd>
							<dd id="BtnR"  onclick='$("#fangan_state").val("");$("#CaseFanganSelectForm").submit();'>全部</dd>
						</dl>
				</div>
			<!--足彩-->
			<!--福彩-->

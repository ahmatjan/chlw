		...
		<tfoot>
			<tr>
				...
				<s:if test="#request.lotNo=='T01007'">
					...
					<em onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))" onclick="window.open('/kaijiang/shishicaikaijiang.html');">更多</em>
				</s:if>
				<!-- 十一运夺金-->
				...
				<em onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))" onclick="reHtml(60,'lotno=T01012&inssuenum=5',false,'Channel','false');newinissue(5);">最近5期</em>
					...
					<em onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))" onclick="window.open('/kaijiang/shiyiyunduojinkaijiang.html');">更多</em>
				</s:elseif>
				<!-- 江西11选5-->
				...
				<em onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))" onclick="reHtml(60,'lotno=T01010&inssuenum=5',false,'Channel','false');newinissue(5);">最近5期</em>
					...
					<em onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))" onclick="window.open('/kaijiang/11xuan5kaijiang.html');">更多</em>
				</s:elseif>
				</div>
				</td>
			</tr>

		...
		<div class="my_account">
			...
			<table class="account_day"  cellspacing="0" cellpadding="0">
				...
				<s:else><tr class="accountDay_greyBg"></s:else>
					...
					<td><a href='/rules/oneBetInfo.html?flowno=<s:property value="presentDetails.orderid"/>&play_name=<s:property value="presentDetails.lotno"/>&batchcode=<s:property value="presentDetails.batchcode"/>&type=2'  target="_blank">查看</a></td>
				</tr>
				</s:iterator>
				</s:if>

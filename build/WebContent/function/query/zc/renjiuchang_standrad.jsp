...
<div class="zucaitable" id="zucai_standrad" style="width:728px;">
	<table width="729" border="0" cellspacing="0" cellpadding="0">
		...
		<tr class="zucai_tr">
			<td class="zucai_biao2" width="49"><img src="/images/quan_3.gif"
				onclick="selectSingleAll9(3)" />
			</td>
			<td class="zucai_biao2" width="49"><img src="/images/quan_1.gif"
				onclick="selectSingleAll9(1)" />
			</td>
			<td class="zucai_biao2" width="50"><img src="/images/quan_0.gif"
				onclick="selectSingleAll9(0)" />
			</td>
		...
		<s:iterator value="#request.list" status="stat">
			<tr id="tr_<s:property value="#stat.count"/>" class="<s:if test="#stat.even">zucai_tr1</s:if>">
              ...
              <td rowspan="2" class="zucai_biao6"><span id="ball3_<s:property value="#stat.count"/>" class="quan_3" onclick="checkColorButtonRenjiu(3,<s:property value="#stat.count"/>);">3</span></td>
              <td rowspan="2" class="zucai_biao6"><span id="ball1_<s:property value="#stat.count"/>" class="quan_3" onclick="checkColorButtonRenjiu(1,<s:property value="#stat.count"/>);">1</span></td>
              <td rowspan="2" class="zucai_biao5"><span id="ball0_<s:property value="#stat.count"/>" class="quan_3" onclick="checkColorButtonRenjiu(0,<s:property value="#stat.count"/>);">0</span></td>
              <td rowspan="2" class="zucai_biao5"><input id="checkbox_<s:property value="#stat.count"/>" type="checkbox" name="checkbox" value="checkbox" onclick="changeColorCheckboxRenjiu(<s:property value="#stat.count"/>);" disabled="disabled"/></td>
...
<script type="text/javascript">cleanReady9()</script>
</div>
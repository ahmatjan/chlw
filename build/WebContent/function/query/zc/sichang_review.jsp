...
<div class="zucaitable" id="zucai_standrad" style="width:728px;">
	<table width="729" border="0" cellspacing="0" cellpadding="0">
		...
		<tr class="zucai_tr">
			<td class="zucai_biao2" width="45"><img src="/images/quan_0_gray.gif" />
			</td>
			<td class="zucai_biao2" width="45"><img src="/images/quan_1_gray.gif" />
			</td>
			<td class="zucai_biao2" width="45"><img src="/images/quan_2_gray.gif" />
			</td>
			<td class="zucai_biao2" width="45"><img
				src="/images/quanjia_3_gray.gif" />
			</td>

	...
	<table width="729" border="0" cellspacing="0" cellpadding="0">
		<tr class="zucai_tr">
			...
			<td class="zucai_biao1" width="31" rowspan="2"><img
				src="/images/quanxuan.gif" onclick="selectCheckboxAll6()" />
			</td>
		...
		<tr class="zucai_tr">
			<td class="zucai_biao2" width="37"><img src="/images/tousan.gif"
				onclick="selectSingleAll6(3)" />
			</td>
			<td class="zucai_biao2" width="35"><img src="/images/touyi.gif"
				onclick="selectSingleAll6(1)" />
			</td>
			<td class="zucai_biao2" width="39"><img
				src="/images/touling.gif" onclick="selectSingleAll6(0)" />
			</td>

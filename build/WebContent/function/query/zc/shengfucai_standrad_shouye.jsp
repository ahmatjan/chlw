...
<tfoot>
	<tr><th colspan="4" >复式截止：<font id="endTime"></font>　您选择了<b id="lab_Num_standrad">0</b>注 <b id="investField_standrad">0</b>元</th><td colspan="2"><input type="button" value="我要投注" onclick="openTouzhu_shouye();" /><span onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))" onclick="cleanZucai();">清空选号</span></td></tr>
</tfoot>

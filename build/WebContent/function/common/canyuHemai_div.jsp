			...
			<table class="BalanceTable">
				...
				<tbody>
					...
					<tr  id="quxiao" style="display: none;" >
						<th colspan="2"><input type="button" value="取　消" class="BaseBtn" onmouseover="BtnOver($(this))" onmouseout="BtnOut($(this))" onmousedown="BtnDown($(this))" onmouseup="BtnUp($(this))" onclick="canyuHemaiShow();" /><a target="_blank" href="/rules/user.html?key=4">立即充值&gt;&gt;</a></th>
					</tr>
							<!-- 确认购买时提示 -->

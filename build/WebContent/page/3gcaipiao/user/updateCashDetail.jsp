...
<%@taglib prefix="s" uri="/struts-tags"%>
		...
		<div class="user_content">
		    ...
		    <table width="798" height="316" border="0" cellpadding="0" cellspacing="0">
	          ...
	          <tr>
		        ...
		        <td class="tikuan_biao2"><input type="hidden" id="Valid_amount" value="<s:property value="#request.objBalance.drawbalance/100"/>"/><s:property value="#request.objBalance.drawbalance/100"/>元</td>
	          </tr>
			  <tr>
			  ...
			  <tr>
			    ...
			    <td class="tikuan_biao2">
			   	 <s:if test="#request.jsonValue_DNA.Name==null || #request.jsonValue_DNA.Name.isEmpty()">
			   	 	 <input type="text" name="cashBean.real_name" id="real_name" value='<s:property value="#request.jsonValue.NAME"/>' onblur="checkName_real()">
			   	 </s:if><s:else>
		...
		<div>
			<input class="xiugai_btn6" type="button" value="" onclick="checkAllUpdate();"/>
		</div>
		</div>
		</form> 

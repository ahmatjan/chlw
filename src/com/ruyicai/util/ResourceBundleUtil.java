...
public class ResourceBundleUtil {
	...
	//pv统计的地址
	public static final String JRTLOTURLPV=rbint.getString("jrtLotUrlPV");
	...
	//获取文件上传路径
	public static final String UPLOAD_PATH = rbint.getString("uploadPath");
	...
	//umBankId
	public static final String UMBANKID = rbint.getString("umBankId");

	public static final String CHANNEL_TO_URL_NUMBER = rbint.getString("channelToUrlNumber");
	public static final String CHANNEL_TO_URL = rbint.getString("channelToUrl");
	...
	//public static String QQ_APP_ID = rbint.getString("qq_app_id");
	//public static String QQ_APP_KEY = rbint.getString("qq_app_key");

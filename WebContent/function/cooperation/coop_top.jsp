...
<div class="HeadMiddleLogo">
	...
	<a class="HomeActivityBanner" href="/index.html"><img src="/images/HomeActivityBanner.jpg" /></a>
	...
	<div class="box">
		...
		<ul>
			...
			<li class="relative" onmouseover="HoverOver($(this));" onmouseout="HoverOut($(this));">
				足球中心
				<dl>
					<dt><a href="#"><img src="/images/Football_score.gif" width="12" height="12" /> 即时比分</a></dt>
					<dd><a href="#"><img src="/images/Football_ratio.gif" width="12" height="12" /> 即时赔率</a></dd>
					<dd><a href="#"><img src="/images/Football_data.gif" width="12" height="12" /> 足彩资料</a></dd>
					<dd><a href="#"><img src="/images/Football_forecast.gif" width="12" height="12" /> 专家预测</a></dd>
				</dl>
			</li>
		</ul>
	</div>

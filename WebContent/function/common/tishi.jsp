		...
		<div class="InsideBorder">
			<table class="BalanceTable">
				...
				<tbody>
					...
					<tr>
						<th colspan="2"><input type="button" value="取　消" class="BaseBtn" onclick="closeAjaxLogin('openRenGou');"/><a href="/rules/user.html?key=4" title="立即充值" target="_blank">立即充值&gt;&gt;</a></th>
					</tr>
				</tbody>
			</table>
		</div>

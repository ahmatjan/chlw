...
<%@taglib prefix="s" uri="/struts-tags"%> 
			...
			<table class="account_check"  cellspacing="0" cellpadding="0">
				<tr>
					<td>起始日期：</td>
					<td><input class="account_time"  type="text" id="startDate" name="startDate" value="${startDate}" onFocus="WdatePicker({alwaysUseStartDate:true})"/></td>
					<td>终止日期：</td>
					<td><input class="account_time" type="text" id="stopDate" name="endDate" value="${stopDate}" onFocus="WdatePicker({alwaysUseStartDate:true})"/></td>
			...
			<ul>
				<li>注：</li>
				<li>1.如果您充值后，银行账户扣了款，如意彩网没有为您加上，请及时与我们联系，我们将第一时间为您处理！</li>
				<li>2.您可以查询您的账户所有的账户明细。</li>
				<li>3.如需要查询全部明细，或您有其他方面需求，请联系网站客服：400-665-1000 </li>
			</ul>

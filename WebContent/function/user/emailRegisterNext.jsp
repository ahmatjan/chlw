...
if($("#sign").html()==''){
	 window.location.href="/rules/emailRegisterIndex.html";
	 }
</script>
...
<div class="RegistePannelBody">
	...
	<div class="Register_code">
		...
		请在48小时内激活。</span></dd>
		<dd><a href='http://<s:property value="#session.emailUrl"/>' title="点击进入" class="Received_mail_btn" target="_blank"><img src="/images/second_jinru.gif" width="116" height="32" /></a></dd>
		</dl>
		<ul class="Noeceived_mail">
			...
			<li>如果再次发送激活信仍未收到，请试试<a href="/rules/emailRegisterIndex.html" title="更改邮箱注册">更改邮箱注册</a></li>
		</ul>
	</div>
</div>
<script>

...
<div class="account_detailed">
	...
	<table class="account_day"  cellspacing="0" cellpadding="0">
		...
		<s:else><tr class="accountDay_greyBg"></s:else>
			...
			<%//-- 追号详情--%>
			<td>
				<a href="/rules/trackNumber.html?key=48&lotNo=<s:property value='lotno'/>&subscribeFlowno=${flowno}&orderId=" target="_blank" title="查看">查看</a>
			</td>
		</tr>
		</s:iterator>
		</s:if>
	...
	<s:else>
	 ...
	 <font class="red1">0</font>元<br />收入交易笔数：0　　　　　收入金额合计：
	 <font class="red1">0</font>元</div>
	</s:else>

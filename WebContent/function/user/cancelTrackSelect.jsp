...
<!--头部橘黄色部分-->
	<div class="togetherPlan_topCenter">
		<div class="togetherPlan_topLeft"></div>
			...
			<s:if test='#request.ordersArray[0].lotno=="T01007"'><img src="/images/logo_ssc_b.gif" width="54" height="54" /></s:if>
			<s:if test='#request.ordersArray[0].lotno=="T01010"'><img src="/images/logo_syxw_b.gif" width="54" height="54" /></s:if>
			<s:if test='#request.ordersArray[0].lotno=="T01012"'><img src="/images/logo_syydj_b.gif" width="54" height="54" /></s:if>
			</div>

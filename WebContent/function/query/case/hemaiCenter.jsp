...
<div class="TogetherCenterRight-down" style="width:778px; height:90px; margin-bottom:10px;">
    <a href="http://www.ruyicai.com/activity/activity20121017.html">
<img src="/images/fadan-fanjiang-bg.gif" width="778" height="90" style=" border:0" /></a>
</div>
<div class="TogetherBuyPannel TogetherCeleb">
	...
	<a href="/bangzhuzhongxin/wanfajieshao/guanfangwanfajieshao/20111021135742_3737.html?id=3737&code1=135&code=129" target="_blank">
	...
	<div class="TogetherBuyPannelInput">
		<dl><s:set  name="lotno_page"  value="%{#parameters.lotno[0]}"/>
			...
			<dd class="select_txt_content">
				...
				<select id="getlonto" name="getlonto" style="height:23px;">
				    ...
				    <option value="J00001">竞彩足球</option>
				</select>
		</dd>
		<dd class="select_txt_content1">
			...
			<div class="InitiatorHM" >
					...
					<li><a href="/jingcaizuqiu.html" title="竞彩足球" target="_blank">竞彩足球</a></li>
					</ul>
				</div>
			</dt>
		</dl>
	...
	<tbody id="CaseHtml">
		...
		<s:iterator id="list" value="#request.hemaiList.list" status="i">
			<tr
				...
				</s:elseif><s:elseif test='#list.torder.lotno=="J00001"'>竞彩足球<s:set
						id="lotno_cn" value='"竞彩足球"' />
				</s:elseif><s:elseif test='#list.torder.lotno=="J00002"'>竞彩足球<s:set
						id="lotno_cn" value='"竞彩足球"' />
				</s:elseif><s:elseif test='#list.torder.lotno=="J00003"'>竞彩足球<s:set
						id="lotno_cn" value='"竞彩足球"' />
				</s:elseif><s:elseif test='#list.torder.lotno=="J00004"'>竞彩足球<s:set
						id="lotno_cn" value='"竞彩足球"' />
				...
				<th><s:i18n name="Format">
					...
					+
<%-- 		<s:if test="(#list.caseLot.buyAmtByStarter+#list.caseLot.buyAmtByFollower)>#list.caseLot.totalAmt" > --%>

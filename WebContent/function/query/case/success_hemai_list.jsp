				...
				<s:elseif  test='#i.index%2==1'>class="TrbgWhite" onmouseout="$(this).attr('class','TrbgWhite')"</s:elseif> 
				 ...
				 <s:elseif test='#list.torder.lotno=="T01006"'>6场半全</s:elseif>
                  ...
                  <s:set name="Nname" value="" />
					...
					<a href="javascript:;" onclick="fanganListToUser('${list.achievement.userno }','${Nname }')" onmouseover="HoverOver($(this))" onmouseout="HoverOut($(this))" >${list.starter.nickname}</a>
					</s:else>
                  </td>
                  ...
                  <td class="red1"><a href="/chlw/function/selectAll!getCaseDetail?caselotId=${list.caseLot.id}" title="入股" target="_blank">入股</a></td>
                </tr>
             </s:iterator>
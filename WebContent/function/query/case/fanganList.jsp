	...
	<div class="WindowTittle">
	  ...
	  <span class="Alertclose" onclick="loginShow('fanganList_Alert',false);">&#160;</span></div>
        ...
        <div class="navigation">
			<ul>
				<li ControlTarget=".JingCai" class="light" onclick='BaseTab($(this));$("#Fangan_lotno").val("J00001");$("#CaseFanganSelectForm").submit();' id="JINGCAI">竞彩</li>
			...
			<!--竞彩-->
				<div class=" Change4 JingCai none" id="followJingCai">
						<dl class="ChangeInput">
							<dt ControlTarget=".Win_jc" class="light selected" onclick='BaseTab($(this));$("#Fangan_lotno").val("J00001");$("#CaseFanganSelectForm").submit();' id="J00001"><span></span>竞彩足球</dt>

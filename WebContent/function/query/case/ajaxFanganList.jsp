...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ChangeTable">
		...
		<tr style="height:25px;" <s:if test='#i.index%2==0' >class="TrbgGrey"</s:if>>
			...
			<a onmouseout="HoverOut($(this))" onmouseover="HoverOver($(this))" href="/chlw/function/selectAll!getCaseDetail?caselotId=<s:property value='#list.caseLot.id'/>">${list.caseLot.displayStateMemo}</a> 
		    </td>
		</tr>
		</s:iterator>
		</tbody>

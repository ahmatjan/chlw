...
span.SmallRedBall{background:url(../images/AllBalls.gif) no-repeat -50px -50px;}
span.SmallBlueBall{ background:url(../images/AllBalls.gif) no-repeat -100px -50px;; }


/*开奖公告标题*/
.LotteryAnnouncement{ width:328px; height:auto; border:1px solid #CCCCCC;}
.LotteryAnnouncement_title{ height:27px; background:url(../images/LotteryAnnouncement_titleBg.gif) repeat-x; overflow:hidden;}
.LotteryAnnouncement_title h3{ color:#1F376D; font-weight:bold; font-size:14px; float:left; background:url(../images/LotteryAnnouncement_titleCon.gif) 6px 9px no-repeat; line-height:27px; padding-left:28px;}
...
<div class="LotteryAnnouncement">
	<div class="LotteryAnnouncement_title">
		<h3>彩票开奖公告</h3>
		<a href="/chlw/function/ryc_select_newkj!drawalottery"  target="_blank" title="查看更多">查看更多>></a>
	</div>
			<table class="LotteryAnnouncement_content">
			<s:iterator value="#request.arrWininfo" id="arrWininfo">
			      <s:if test="id.lotno=='F47104'">
				<tr>
					<th rowspan="3"><img src="../images/logo_ssq_b.gif" width="54" height="54" /></th>
					<td>第<i><s:property value="id.batchcode"/></i>期</td>
					<td><a href="/kaijiang/shuangseqiukaijiang.html" target="_blank" title="查询往期">查询往期</a></td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					...
					<a href="/fucaituijian/fucaituijian_shuangseqiu_1.html"  target="_blank" title="推荐">推荐>></a><a href="/shuangseqiu.html"  target="_blank" title="立即投注">立即投注>></a>
					</td>
				</tr>
				</s:if>
					<s:elseif test="id.lotno=='F47103'">
				<tr>
					<th rowspan="3"><img src="../images/logo_fcsd_b.gif" width="54" height="54" /></th>
					<td>第<i><s:property value="id.batchcode"/></i>期</td>
					<td><a href="/kaijiang/fucai3Dkaijiang.html" target="_blank" title="查询往期">查询往期</a></td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					...
					<a href="/fucaituijian/fucaituijian_fucai3D_1.html" target="_blank" title="推荐">推荐>></a><a href="/fucai3D.html" target="_blank" title="立即投注">立即投注>></a>
					</td>
				</tr>
				</s:elseif>
					<s:elseif test="id.lotno=='T01001'">
				<tr>
					<th rowspan="3"><img src="../images/logo_dlt_b.gif" width="54" height="54" /></th>
					<td>第<i><s:property value="id.batchcode"/></i>期</td>
					<td><a href="/kaijiang/daletoukaijiang.html"  target="_blank" title="查询往期">查询往期</a></td>
				</tr>
				<tr>
					<td colspan="2">
						<span class="SmallRedBall"><s:property value="winbasecode.substring(0,2)"/></span>
				...
				<tr>
					...
					<a href="/ticaituijian/ticaituijian_daletou_1.html" target="_blank" title="推荐">推荐>></a><a href="/daletou.html" target="_blank" title="立即投注">立即投注>></a>
					</td>
				</tr>
				</s:elseif>
				</s:iterator>

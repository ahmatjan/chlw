...
<s:if test='id.lotno=="F47104"'>
	<div class="ChannelBuyPannel ChannelBuyBulletin">
		<div class="ChannelBuyPannelHead"><h3>双色球开奖公告</h3><a href="/kaijiang/shuangseqiukaijiang.html">更多&gt;&gt;</a></div>
			...
			<ol>
				...
				<li>
					...
					<dl class="DlList WinIntroMore" onmouseover="HoverOver($(this));" onmouseout="HoverOut($(this));">
                        <dt><a href="/kaijiang/shuangseqiukaijiang.html">详情&gt;&gt;</a></dt>
                        <dd>
...
<s:if test='id.lotno=="F47103"'>
	<div class="ChannelBuyPannel ChannelBuyBulletin">
		<div class="ChannelBuyPannelHead"><h3>福彩3D开奖公告</h3><a href="/kaijiang/fucai3Dkaijiang.html">更多&gt;&gt;</a></div>
		<div class="ChannelBuyPannelBody">
			<ol>
				...
				<!-- 开奖公告展开 start  -->
					<dl class="DlList WinIntroMore" onmouseover="HoverOver($(this));" onmouseout="HoverOut($(this));">
                        <dt><a href="/kaijiang/fucai3Dkaijiang.html">详情&gt;&gt;</a></dt>
...
<s:if test='id.lotno=="F47102"'>
	<div class="ChannelBuyPannel ChannelBuyBulletin">
		<div class="ChannelBuyPannelHead"><h3>七乐彩开奖公告</h3><a href="/kaijiang/qilecaikaijiang.html">更多&gt;&gt;</a></div>
		<div class="ChannelBuyPannelBody">
			<ol>
				...
				<li>
					...
					<!-- 开奖公告展开 start  -->
					<dl class="DlList WinIntroMore" onmouseover="HoverOver($(this));" onmouseout="HoverOut($(this));">
                        <dt><a href="/kaijiang/qilecaikaijiang.html">详细&gt;&gt;</a></dt>
                          <s:if test="infos.prizeInfos.size()>0">
                        <dd>
                            <div class="triangle">&nbsp;</div>
                            <div class="DlLsitContent">
...
<s:if test='id.lotno=="T01013"'>
	<div class="ChannelBuyPannel ChannelBuyBulletin">
		<div class="ChannelBuyPannelHead"><h3>22选5开奖公告</h3><a href="/kaijiang/22xuan5kaijiang.html">更多&gt;&gt;</a></div>
		<div class="ChannelBuyPannelBody">
			<ol>
				...
				<li>
					...
					<!-- 开奖公告展开 start  -->
					<dl class="DlList WinIntroMore" onmouseover="HoverOver($(this));" onmouseout="HoverOut($(this));">
                        <dt><a href="/kaijiang/22xuan5kaijiang.html">详细&gt;&gt;</a></dt>
                          <s:if test="infos.prizeInfos.size()>0">
                        <dd>
                            <div class="triangle">&nbsp;</div>
                            <div class="DlLsitContent">
...
<s:if test='id.lotno=="T01002"'>
	<div class="ChannelBuyPannel ChannelBuyBulletin">
		<div class="ChannelBuyPannelHead"><h3>排列三开奖公告</h3><a href="/kaijiang/pailiesankaijiang.html">更多&gt;&gt;</a></div>
		<div class="ChannelBuyPannelBody">
			<ol>
				...
				<!-- 开奖公告展开 start  -->
					<dl class="DlList WinIntroMore" onmouseover="HoverOver($(this));" onmouseout="HoverOut($(this));">
                        <dt><a href="/kaijiang/pailiesankaijiang.html">详情&gt;&gt;</a></dt>
                         <s:if test="infos.prizeInfos.size()>0">
                        <dd>
                            <div class="triangle">&nbsp;</div>
                            <div class="DlLsitContent">
...
<s:if test='id.lotno=="T01001"'>
	<div class="ChannelBuyPannel ChannelBuyBulletin">
		<div class="ChannelBuyPannelHead"><h3>大乐透开奖公告</h3><a href="/kaijiang/daletoukaijiang.html">更多&gt;&gt;</a></div>
		<div class="ChannelBuyPannelBody">
			<ol>
				...
				<li>
					...
					<!-- 开奖公告展开 start  -->
					<dl class="DlList WinIntroMore" onmouseover="HoverOver($(this));" onmouseout="HoverOut($(this));">
                        <dt><a href="/kaijiang/daletoukaijiang.html">详情&gt;&gt;</a></dt>
                         <s:if test="infos.prizeInfos.size()>0">
                        <dd>
                            <div class="triangle">&nbsp;</div>
                            <div class="DlLsitContent">
...
<s:if test='id.lotno=="T01011"'>
	<div class="ChannelBuyPannel ChannelBuyBulletin">
		<div class="ChannelBuyPannelHead"><h3>排列五开奖公告</h3><a href="/kaijiang/pailiewukaijiang.html">更多&gt;&gt;</a></div>
		<div class="ChannelBuyPannelBody">
			<ol>
				...
				<!-- 开奖公告展开 start  -->
					<dl class="DlList WinIntroMore" onmouseover="HoverOver($(this));" onmouseout="HoverOut($(this));">
                        <dt><a href="/kaijiang/pailiewukaijiang.html">详情&gt;&gt;</a></dt>
                        <s:if test="infos.prizeInfos.size()>0">
                        <dd>
                            <div class="triangle">&nbsp;</div>
                            <div class="DlLsitContent">
...
<s:if test='id.lotno=="T01009"'>
	<div class="ChannelBuyPannel ChannelBuyBulletin">
		<div class="ChannelBuyPannelHead"><h3>七星彩 开奖公告</h3><a href="/kaijiang/qixingcaikaijiang.html">更多&gt;&gt;</a></div>
		<div class="ChannelBuyPannelBody">
			<ol>
				...
				<li>
					...
					<!-- 开奖公告展开 start  -->
					<dl class="DlList WinIntroMore" onmouseover="HoverOver($(this));" onmouseout="HoverOut($(this));">
                        <dt><a href="/kaijiang/qixingcaikaijiang.html">详情&gt;&gt;</a></dt>
                          <s:if test="infos.prizeInfos.size()>0">
                        <dd>
                            <div class="triangle">&nbsp;</div>
                            <div class="DlLsitContent">
            ...
            4场进球第<span class="red"><strong><s:property value="id.batchcode"/></strong></span>期<br />
              ...
              <table width="100%"   cellspacing="0" cellpadding="0" >
                       ...
                       <td class="footballtd2">一等奖</td>
                         ...
                         <s:else>
                         <td class="footballtd2"><s:property value="info.winnumber1"/>注</td><td class="footballtd3"><s:property value="info.winmoney1"/>元</td>
                         </s:else>
               		   </tr>
               		   <tr>
              ...
              <table width="100%"   cellspacing="0" cellpadding="0" >
                       ...
                       <s:if test='info=="wkj"'>
	                        ...
	                        <tr><td class="footballtd2">胜负销量</td><td class="footballtd3" colspan="2">未开奖</td></tr>
                         	 ...
                         	 <tr><td class="footballtd2" >二等奖</td>
                         	 	<td  class="footballtd2" ><s:property value="info.winnumber2"/>注</td><td class="footballtd3" ><s:property value="info.winmoney2"/>元</td>
                         	 </tr>

	...
	<table border="0" cellspacing="0" cellpadding="0">
		<tr class="zucai_tr">
			...
			<td class="zucai_biao1" width="41" rowspan="2"><img
				src="/images/quanxuan_gray.gif" /></td>
		...
		<tr class="zucai_tr">
			<td class="zucai_biao2" width="49"><img src="/images/quan_3_gray.gif" />
			</td>
			<td class="zucai_biao2" width="49"><img src="/images/quan_1_gray.gif" />
			</td>
			<td class="zucai_biao2" width="50"><img src="/images/quan_0_gray.gif" />
			</td>
		...
		<s:iterator value="#request.list" status="stat">
			...
			<tr id="tr_<s:property value="#stat.count"/>" class="<s:if test="#stat.even">zucai_tr1</s:if>">
			  ...
			  <s:if test='"3"==result||"*"==result'>
					<td rowspan="2" class="zucai_biao6">
						<span class="quan_1qian">3</span>
					</td>
				</s:if>
				<s:else>
					<td rowspan="2" class="zucai_biao6">
						<span class="quan_2">3</span>
					</td>
				</s:else>
				
				<s:if test='"1"==result||"*"==result'>
					<td rowspan="2" class="zucai_biao6">
						<span class="quan_1qian">1</span>
					</td>
				</s:if>
				<s:else>
					<td rowspan="2" class="zucai_biao6">
						<span class="quan_2">1</span>
					</td>
				</s:else>
				
				<s:if test='"0"==result||"*"==result'>
					<td rowspan="2" class="zucai_biao6">
						<span class="quan_1qian">0</span>
					</td>
				</s:if>
				<s:else>
					<td rowspan="2" class="zucai_biao6">
						<span class="quan_2">0</span>
					</td>
				</s:else>

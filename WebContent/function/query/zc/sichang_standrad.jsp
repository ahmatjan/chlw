	...
	<table width="729" border="0" cellspacing="0" cellpadding="0">
		<tr class="zucai_tr">
			...
			<td class="zucai_biao1" width="29" rowspan="2"><img
				src="/images/quanxuan.gif" onclick="selectCheckboxAll4()" />
			</td>
		...
		<tr class="zucai_tr">
			<td class="zucai_biao2" width="45"><img src="/images/quan_0.gif"
				onclick="selectSingleAll4(0)" />
			</td>
			<td class="zucai_biao2" width="45"><img src="/images/quan_1.gif"
				onclick="selectSingleAll4(1)" />
			</td>
			<td class="zucai_biao2" width="45"><img src="/images/quan_2.gif"
				onclick="selectSingleAll4(2)" />
			</td>
			<td class="zucai_biao2" width="45"><img
				src="/images/quanjia_3.gif" onclick="selectSingleAll4(3)" />
			</td>

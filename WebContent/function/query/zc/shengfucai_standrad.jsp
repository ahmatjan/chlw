	...
	<table border="0" cellspacing="0" cellpadding="0">
		<tr class="zucai_tr">
			...
			<td class="zucai_biao1" width="41" rowspan="2"><img
				src="/images/quanxuan.gif" onclick="selectCheckboxAll14()"/></td>
		...
		<tr class="zucai_tr">
			<td class="zucai_biao2" width="49"><img src="/images/quan_3.gif" onclick="selectSingleAll14(3)"/>
			</td>
			<td class="zucai_biao2" width="49"><img src="/images/quan_1.gif" onclick="selectSingleAll14(1)"/>
			</td>
			<td class="zucai_biao2" width="50"><img src="/images/quan_0.gif" onclick="selectSingleAll14(0)"/>
			</td>

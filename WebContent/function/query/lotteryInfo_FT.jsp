		...
		<div class="announcement_border">
			...
			<div class="shiShi_table">
				<ul class="shuangSe_infor">
					...
					<li>
						<input type="button" value="立即投注" class="shuangSe_btn" onclick="javaScript:location.href='/shuangseqiu.html'"/>
					</li>
				</ul>
		...
		<div class="announcement_border">
			...
			<div class="shiShi_table">
				<ul class="shuangSe_infor">
					...
					<li>奖池累计金额：<s:property value="infos.progressive"/>元</li>
					<li>
						<input type="button" value="立即投注" class="shuangSe_btn" onclick="javaScript:location.href='/fucai3D.html'"/>
		...
		<div class="announcement_border">
			...
			<div class="shiShi_table">
				<ul class="shuangSe_infor">
					...
					<li>奖池累计金额：<s:property value="infos.progressive"/>元</li>
					<li>
						<input type="button" value="立即投注" class="shuangSe_btn" onclick="javaScript:location.href='/qilecai.html'"/>
            	</ul>
				<table cellspacing="0" cellpadding="0" class="shuangSe_rightTable">
					<thead>
						<s:if test="#status.odd">
		...
		<div class="announcement_border">
			...
			<div class="shiShi_table">
				<ul class="shuangSe_infor">
					...
					<li>奖池累计金额：<s:property value="infos.progressive"/>元</li>
					<li>
						<input type="button" value="立即投注" class="shuangSe_btn" onclick="javaScript:location.href='/pailie3.html'"/>
				</li>
				</ul>
				<table cellspacing="0" cellpadding="0" class="shuangSe_rightTable">
					<thead>
		...
		<div class="announcement_border">
			...
			<div class="shiShi_table">
				<ul class="shuangSe_infor">
					...
					<li>奖池累计金额：<s:property value="infos.progressive"/>元</li>
					<li>
						<input type="button" value="立即投注" class="shuangSe_btn" onclick="javaScript:location.href='/daletou.html'"/>
				</li>
				</ul>
		...
		<div class="announcement_border">
			...
			<div class="shiShi_table">
				<ul class="shuangSe_infor">
					...
					<li>奖池累计金额：<s:property value="infos.progressive"/>元</li>
					<li>
						<input type="button" value="立即投注" class="shuangSe_btn" onclick="javaScript:location.href='/pailie5.html'"/>
		...
		<div class="announcement_border">
			...
			<div class="shiShi_table">
				<ul class="shuangSe_infor">
					...
					<li>奖池累计金额：<s:property value="infos.progressive"/>元</li>
					<li>
						<input type="button" value="立即投注" class="shuangSe_btn" onclick="javaScript:location.href='/qixingcai.html'"/>
					</li>
				</ul>
				<table cellspacing="0" cellpadding="0" class="shuangSe_rightTable">
					<thead>

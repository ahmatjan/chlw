<%@ page language="java" contentType="text/html; charset=utf-8"
 ...
 <div class="ChannelBuyWinNum_11xuan5">
	<style>
		...
		.ChannelBuyWinNum_11xuan5 thead th{ font-size:12px; font-weight:normal; color:#000000; text-align:center; border:solid 1px #DBDBDB; line-height:30px; background:url(/images/ChannelBuyPannelHeader.png) repeat-x bottom left;}

							...
							<tr class="bg">
								...
								<td><span style="cursor: pointer; color:Blue">
									<s:if test='bettype==3 && businessId != null && !businessId.equals("null")'>
										<a href='/chlw/function/selectAll!getCaseDetail?caselotId=<s:property value="businessId"/>'  target="_blank">查看订单</a>
									</s:if>
									<s:elseif test='bettype==1 && businessId != null && !businessId.equals("null")'>
									   <a href='/rules/oneBetInfo.html?flowno=<s:property value="businessId"/>&play_name=<s:property value="lotno"/>'  target="_blank">查看订单</a>
									</s:elseif>
									<s:elseif test='bettype==2 && businessId != null && !businessId.equals("null")'>
									   <a href='/rules/trackNumber.html?key=48&subscribeFlowno=<s:property value="businessId"/>&lotNo=<s:property value="lotno"/>'  target="_blank">查看订单</a>
									</s:elseif>
							</span></td>
							</tr>
							</s:iterator>
